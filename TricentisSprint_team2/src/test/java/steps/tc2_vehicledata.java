...
public class tc2_vehicledata extends Screenshots {
...
@When("he enters vehicle data for automobile from {string} and {int}")
public void he_enters_vehicle_data_for_automobile_from_and(String SheetName, Integer RowNumber) throws InvalidFormatException, IOException {
